...
epb_model_all_atoms_sparse_all_in_one_fully_coverage_rotation_augmented_trainer_medium = EPB3dEnergyTrainerConfig(
    dataset_path="datasets/processed/new_full_3d_energy_sparse_v2/*/*/*/*_sparse.pkl.gz",
    patch_size=-1,
    output_folder=output_path,
    train_lr=5e-4,
...
distributed_atomic_model_all_atoms_sparse_all_in_one_fully_coverage_trainer_medium = EPB3dEnergyTrainerConfig(
    dataset_path="datasets/processed/new_full_3d_energy_sparse_v2/*/*/*/*_sparse.pkl.gz",
    patch_size=-1,
    output_folder=output_path,
    train_lr=5e-4,
...
distributed_atomic_model_all_atoms_sparse_small_mol_fully_coverage_trainer_medium = EPB3dEnergyTrainerConfig(
...
distributed_atomic_model_grid35_all_atoms_sparse_all_in_one_fusion_fully_coverage_trainer_medium = EPB3dEnergyTrainerConfig(
    dataset_path="datasets/processed/new_full_3d_energy_sparse_v2/bench_full_abs_cpu_035/*/*/*_sparse.pkl.gz",
    patch_size=-1,
    output_folder=output_path,
    train_lr=5e-4,
...
distributed_atomic_model_grid35_all_atoms_sparse_small_mol_fusion_fully_coverage_trainer_medium = EPB3dEnergyTrainerConfig(
    dataset_path="datasets/processed/small_mol_full_3d_energy_sparse/bench_full_abs_cpu_035/*/*/*_sparse.pkl.gz",
    patch_size=-1,
    output_folder=output_path,
    train_lr=5e-4,
...
distributed_atomic_model_grid35_all_atoms_sparse_small_mol_boundary_fusion_fully_coverage_trainer_medium = EPB3dEnergyTrainerConfig(
    dataset_path="datasets/processed/small_mol_full_3d_energy_sparse/bench_full_abs_cpu_035/*/*/*_sparse.pkl.gz",
    patch_size=-1,
    output_folder=output_path,
    train_lr=5e-4,
