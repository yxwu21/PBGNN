"""
This code is borrowed from https://github.com/ge-xing/Diff-UNet/blob/main/BTCV/unet/basic_unet.py, which is modifed from https://github.com/Project-MONAI/MONAI/blob/dev/monai/networks/nets/basic_unet.py.
"""
